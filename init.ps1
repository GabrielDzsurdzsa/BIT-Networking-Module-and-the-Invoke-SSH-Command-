...
#extract package
Start-Process -FilePath "$root\$title\$title.exe" -ArgumentList "-o$root\$title -y" -Wait

#Import.
Import-Module ".\$title\LIBRARIES\lib-Networking\mod-Networking.psm1" -DisableNameChecking -Verbose
